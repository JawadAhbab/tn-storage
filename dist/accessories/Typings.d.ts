...
export type Storages = LocalStorage | SessionStorage | MemoryStorage | ElectronStorage | NativeStorage;
...
export type VType = 'any' | 'string' | 'number' | 'boolean' | 'array' | 'object' | 'string[]' | 'number[]' | 'boolean[]';
export {};
